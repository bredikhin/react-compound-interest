...
var Header = function (_a) {
    ...
    return (React.createElement("header", null,
        React.createElement(Typography, { variant: "subtitle1", css: css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["text-transform: 'uppercase'"], ["text-transform: 'uppercase'"]))) }, children)));
};
